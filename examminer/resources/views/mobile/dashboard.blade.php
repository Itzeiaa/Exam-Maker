...
<head>
  ...
  <title>Exam Maker — Dashboard (Mobile)</title>
  ...
  <header class="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-200"
    ...
    <div class="flex items-center justify-between px-4 py-3">
      ...
      <a href="/dashboard" class="flex items-center gap-3">
        ...
        <h1 class="font-bold text-gray-900 leading-tight whitespace-nowrap text-[clamp(1.1rem,4.6vw,1.35rem)]">Exam Maker</h1>
      </a>
    ...
    <section id="emptySection" class="hidden bg-white rounded-xl shadow-lg p-6 border border-gray-100">
      <div class="text-center">
        ...
        <p class="text-gray-600 mb-8 max-w-md mx-auto">
          Welcome to Exam Maker! You haven't created any exams yet. Let's get started by creating your first exam.
        </p>
